...
EOF
    ...
    ./_build/old/terrad tx gov submit-proposal $HOME/upgrade_proposal.json --from test1 --keyring-backend test --chain-id $CHAIN_ID --home $HOME --gas-prices $GAS_PRICE -y
